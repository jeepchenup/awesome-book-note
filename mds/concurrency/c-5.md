...
-   [AQS 的代码实现](#user-content-aqs-3)
    ...
    -   [独占式同步状态的获取与释放](#user-content-aqs-3-2)
        -   [加入同步队列 - addWaiter](#user-content-aqs-3-2-1)
        -   [自旋获取同步状态 - acquireQueued](#user-content-aqs-3-2-2)
        -   [判断是否需要阻塞线程 - shouldParkAfterFailedAcquire](#user-content-aqs-3-2-3)
-   LockSupport
...
### <a id="aqs-3-2-3">shouldParkAfterFailedAcquire</a>

**shouldParkAfterFailedAcquire** 根据前节点的 **waitStatus** 来决定当前节点的线程是否需要被阻塞。
