...
-   [JDK1.7](#user-content-jdk7)
    -   [HashMap初始化](#user-content-init-jdk7)
    -   [put详解](#user-content-put-jdk7)
        -   [计算key对应的下标](#user-content-key-index-jdk7)
        -   [添加节点到链表中](#user-content-add-entry-jdk7)
        -   [扩容](#user-content-rehash-jdk7)
    -   [get](#user-content-get-jdk7)
    -   [为什么说HashMap是非线程安全？](#user-content-not-security-jdk7)
    -   [JDK7 HashMap总结](#user-content-summary-jdk7)
-   [JDK1.8](#user-content-jdk8)
    -   [put详解](#user-content-put-jdk8)
        -   [扩容](#user-content-rehash-jdk8)    
...
1. HashMap数据结构从 **数组+链表** 到 **数组+红黑树** 的转变根据是由 **`TREEIFY_THRESHOLD == 8`** 来决定的。当要添加的链表长度大于8个节点时，会将链表转变成红黑树。
