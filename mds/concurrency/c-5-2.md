        ...
        if (!readerShouldBlock() &&
            ...
            if (r == 0) {
                ...
                if (rh == null || rh.tid != current.getId())
                     ...
                     * 如果当前线程的 cachedHoldCounter 为null，或者，线程本地变量 cachedHoldCounter 储存的tid不是当前线程的ID，那么给当前线程初始化一个线程本地变量cachedHoldCounter。
                     */
                    cachedHoldCounter = rh = readHolds.get();
                else if (rh.count == 0)
                    // cachedHoldCounter已经初始化且count == 0 的时候，将cachedHoldCounter设置为当前线程本地变量。
                    readHolds.set(rh);
                rh.count++;
            }
            return 1;
