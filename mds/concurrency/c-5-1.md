...
-   [2. 实战](#user-content-aqs-2)
    ...
    -   [2.2 tryLock(long, TimeUnit) & tryLock()](#user-content-aqs-2-2)
...
> 注意，我正在使用synchronized块获取资源对象上的锁。我们可以在类中创建一个虚拟对象并将其用于锁定目的。

现在让我们看看如何使用Java Lock API 来替代上面的 synchronized。
